...
public class SpringBatchTutorialConfiguration {
	...
	@Bean
	public ItemReader<CustomPojo> reader1() {
	 ...
	 */
	@Bean
	public ItemProcessor<CustomPojo, CustomPojo> processor1() {
	 ...
	 */
	@Bean
	public ItemWriter<CustomPojo> writer1(DataSource dataSource) {
	 ...
	 else if ("derbydb".equals(this.mode)) {
		JdbcBatchItemWriter<CustomPojo> writer = new JdbcBatchItemWriter<CustomPojo>();
	 ...
	 */
	@Bean
	public Job importUserJob1(JobBuilderFactory jobs, Step s1) {
...
//	}
	...
	public DataSource dataSource() throws SQLException {
		if ("mongo".equals(this.mode)) {
			...
			final DriverManagerDataSource dataSource = new DriverManagerDataSource();
			dataSource.setDriverClassName("org.apache.derby.jdbc.embebdedDriver");
			dataSource
					.setUrl("jdbc:derby://localhost:1527/MyDbTest");
			return dataSource;
		} else {
			// hsqldb datasource
			final DriverManagerDataSource dataSource = new DriverManagerDataSource();
